...
parser.add_argument('--seed', type=int, default=-1,
                    help='global seed for reproducible training. Use -1 to keep the current stochastic behavior.')
parser.add_argument('--csv_log_dir', type=str, default=None,
                    help='directory for Lightning CSVLogger; defaults to logs/mwirnet under the project root.')
parser.add_argument('--save_last_only', action='store_true',
                    help='only keep the final checkpoint during training.')
...
parser.add_argument('--wblogger', type=str, default=None,
                    help='W&B project name. Use none/false/off or omit to log locally.')
...
parser.add_argument('--precision', type=str, default='32-true',
                    help='Lightning precision setting, e.g. 32-true or 16-mixed')
