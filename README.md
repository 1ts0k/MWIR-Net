...
对比图原图保存在 `visual_comparisons/rain100l_comparison.png` 和 `visual_comparisons/sots_outdoor_comparison.png`。PPT 使用的对比图保存在 `visual_comparisons/ppt_5k_protocol/`，其中保留了 Rain100L 和 SOTS outdoor 的网格图与单样本横向对比条。额外的 Rain100L 消融、Rain100H、Test1200、Test2800 和 NYU-Haze500 网格图放在 `visual_comparisons/extra_benchmarks/`。
