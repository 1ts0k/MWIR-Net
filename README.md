...
对比图原图保存在 `visual_comparisons/rain100l_comparison.png` 和 `visual_comparisons/sots_outdoor_comparison.png`。PPT 使用的对比图保存在 `visual_comparisons/ppt_5k_protocol/`，其中保留了 Rain100L 和 SOTS outdoor 的网格图与单样本横向对比条。
